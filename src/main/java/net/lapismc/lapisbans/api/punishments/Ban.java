...
public class Ban extends Punishment {
    ...
    public Ban(UUID source, UUID target, String reason, boolean isTemp, Long expiry, boolean isShadow) {
        super(source, target, reason, isTemp, expiry);
    ...
    public Long getTimePlaced(DataStore ds) {
        if (isTemp()) {
            return ds.getLong(Tables.History.name(), "Expiry", "Time", getExpiry().toString());
        } else {
